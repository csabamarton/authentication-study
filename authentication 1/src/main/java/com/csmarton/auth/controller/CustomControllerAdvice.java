...
public class CustomControllerAdvice {
    ...
    public ResponseEntity<ErrorResponse> handleUserAlreadyExistsExceptions(Exception e) {
    ...
    public ResponseEntity<ErrorResponse> handleBadCredentialExceptions(Exception e) {
        HttpStatus status = HttpStatus.BAD_REQUEST; // 400
